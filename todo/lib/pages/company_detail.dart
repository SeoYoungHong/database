...
import 'package:todo/pages/company_info.dart';
...
class CompanyDetail extends StatefulWidget {
  final int idx;
  const CompanyDetail({Key? key, required this.idx}) : super(key: key);
          ...
          child: GetBuilder<NoticeState>(
            builder: ((controller) => Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: (){Get.to(CompanyInfo(idx: idx));},
                      child: Text('companytitle', style: TextStyle(fontSize: 18),),
                    )
                  ],
                )),
          ),
